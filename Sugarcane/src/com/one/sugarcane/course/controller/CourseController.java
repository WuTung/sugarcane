...
public class CourseController {
	...
	public void listsinglecake(@RequestParam(value = "courseID") Integer courseID, HttpSession session,
	...
	public void AddOneCourse(@RequestParam("courseName") String courseName, @RequestParam("price") double price,
		...
		SellerLogin sellerLogin = (SellerLogin) session.getAttribute("sellerLogin");
		// PublicCourseType
		// publicCourseType=this.courseServiceImpl.selectPublicCourseTypeByID(sellerCourseType);
