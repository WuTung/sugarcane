...
<!--body-->
    <div class="body">
        ...
        <form action="${pageContext.request.contextPath}/userInfo/update" method="post">
            <div class="top_form">
                <div class="sex">
            ...
            <div class="top_select">
                ...
                <div class="mixselect">
                	<c:forEach items="${publicTypes }" var="publicType">
	                	<label class="demo--label">
	                        <input class="demo--radio" type="checkbox" name="publicTypeNames" value="${publicType.publicTypeName }">
	                        <span class="demo--checkbox demo--radioInput"></span>${publicType.publicTypeName }
	                    </label>
					</c:forEach>
                </div>
                <div class="save">
